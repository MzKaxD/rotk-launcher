...
| Vivox 5 client runtime | Proprietary Unity/Vivox runtime, distributed only inside official project installers | <https://unity.com/legal/licenses/unity-package-distribution-license> |
...
Official ROTK installers may include the Unity-signed Vivox 5 client runtime as a binary component required by the voice-chat integration. That runtime is governed by the applicable Unity/Vivox terms and notices and is not relicensed under GPL-3.0.
