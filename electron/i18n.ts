...
const ENGLISH_ERRORS = new Map<string, string>([
  ...
  ["Cette version de H1Z1 n’est pas compatible avec le patch de gameplay ROTK obligatoire. Vérifie les fichiers du jeu dans Steam puis réessaie.", "This H1Z1 version is not compatible with the mandatory ROTK gameplay patch. Verify the game files in Steam and try again."],
  ["La DLL de gameplay ROTK embarquée est invalide.", "The bundled ROTK gameplay DLL is invalid."],
  ["Le patch de gameplay ROTK obligatoire n'a pas été copié correctement.", "The mandatory ROTK gameplay patch was not copied correctly."],
